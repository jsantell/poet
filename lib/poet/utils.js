...
function createPostFromDb (postObj, options) {
    var parsed = (options.metaFormat === 'yaml' ? yamlFm : jsonFm)(postObj.renderAsFrontmatter());
    var body = parsed.body;
    var post = parsed.attributes;
    var shortName = postObj._id.toString()
...
exports.createPostFromDb = createPostFromDb;

/**
 * Accepts a path of a file and an options hash and returns an object
...
function createPostFromFile (filePath, options) {
...
exports.createPostFromFile = createPostFromFile;
