...
function addRoute (poet, route, handler) {
  ...
  if (currentRoute) {
    ...
    if (poet.app.routes) {
      ...
      // Express >= 4 does not include a routes object that contains all the route information
      // instead we must use the Router object and itterate through its contents
