module.exports = function ( app, options ) {
  ...
  options = {
    ...
    postRoute     : options.postRoute     ? appendSlash( options.postRoute )     : '/post/',
    postListRoute : options.postListRoute ? appendSlash( options.postListRoute ) : '/posts/',
    tagRoute      : options.tagRoute      ? appendSlash( options.tagRoute )      : '/tag/',
    categoryRoute : options.categoryRoute ? appendSlash( options.categoryRoute ) : '/category'
  };
  ...
  function setupReferences () {
    ...
    app.helpers({
      ...
      pageUrl       : function ( page ) {
        return options.postListRoute + page;
      }
    });
  }
